...
class Thread1(threading.Thread):
    def __init__(self, threadName, pageQueue, dataQueue):
        ...
        self.error_path = r'C:\Users\Jeffrey\Desktop\Spider_\log\error.log'
...
class Thread2(threading.Thread):
    def __init__(self, threadName, dataQueue):
        ...
        self.dataQueue = dataQueue
        self.threadName = threadName
        self.path = r'C:\Users\Jeffrey\Desktop\Spider_'
        self.error_path = r'C:\Users\Jeffrey\Desktop\Spider_\log\error.log'
...
def main():
        ...
        try:
            ...
            try:
                et = datetime.datetime.now()
                error_path = r'C:\Users\Jeffrey\Desktop\Spider_\log\error.log'
